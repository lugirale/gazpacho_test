...
public class EnglishOrderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.english_fragment_order, parent, false);
...
/***********************************************************************************/
        ...
        mDate.setText("Date: "+dfEN.format(date)+" " +gmtTime);
/***********************************************************************************/
...
/***********************************************************************************/
        ...
        if(mIngredients.size() == 0){
            mIngredientsView.setText("classic gaspacho");
        }else
            ...
            public void onClick(View v) {
                ...
                if( v == mOrderButton ){
                    ...
                    if((lang.compareTo("en")) == 0){
                        ...
                        usbCtrl.sendByte(cmd, dev);
                        parallevar = mTakeaway;
                        String parallevar2 = "to take away";
